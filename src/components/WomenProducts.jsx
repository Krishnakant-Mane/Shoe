...
export const WomenProducts = () => {
    ...
    const womenItems = products.filter((item) => item.productGender === "Women");
    console.log(womenItems);


    return (
        <>
            <div id='womens' className='flex justify-center w-full md:py-5 md:pt-20 pt-25'>
                <h1 className='md:text-6xl playfair text-5xl font-semibold'>QUEEN'S COLLECTION</h1>
            </div>
