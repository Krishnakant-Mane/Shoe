...
export const Products = () => {
    ...
    return (
        <>
            ...
            <div className="flex flex-wrap justify-center gap-5 md:px-50 md:py-5 py-5  min-h-screen">
                {products.map((item) => (
                    <div key={item.id} className='flex flex-col md:w-120 md:h-170 md:p-5 p-5 rounded-2xl shadow-2xl bg-gray-50 gap-5'>
                        ...
                        <div className='h-100 w-full relative group overflow-hidden'>
                            ...
                            <img className='w-full h-full object-cover z-0 hover:scale-120 transition-transform duration-500' src="https://static.nike.com/a/images/t_web_pdp_936_v2/f_auto/706dd7a7-2c39-4ae1-8a3d-09a7e31b8dad/AIR+MAX+DN8+LTHR.png" alt="" />
                        </div>
                        <div>
